...
public class JWTCreatorTestAbstract extends AbstractTestDataCreatorTest {

  private static final Logger log = Logger.getLogger(JWTCreatorTestAbstract.class.getCanonicalName());
