...
import { fetchDialects } from 'reducers/fvDialect'
import { fetchLanguage } from 'reducers/fvLanguage'
        ...
        <div className="row">
          <div className="col-xs-12">
            <h1>
              ...
              <FVLabel transKey="dialects" defaultStr="Dialects" transform="words" />
            </h1>
