...
/**
 * @summary SearchPresentationList
 * @component
 *
 * @param {object} props
 *
 ...
 */
function SearchPresentationList({ actions, isLoading, items, moreActions, sitename, wholeDomain }) {
  return (
...
SearchPresentationList.propTypes = {
  actions: array,
  isLoading: bool,
  items: arrayOf(
    shape({
...
SearchPresentationList.defaultProps = {
  wholeDomain: false,
  actions: [],
  moreActions: [],
}

export default SearchPresentationList
