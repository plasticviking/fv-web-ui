...
module.exports = (env) => ({
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      ...
      filename: path.join(outputScriptsDirectory, 'remoteEntry.' + 'skaffold' + '.js'),
      exposes: {
    ...
    new HtmlWebpackSkipAssetsPlugin({
      ...
      skipAssets: [path.join(outputScriptsDirectory, 'remoteEntry.' + 'skaffold' + '.js')],
    }),
  ],
