...
public class EditPublishDraftTest {
  ...
  @Test
  public void editPublishDraftTest() {
    ...
    testUtil.publishDraftViaAutomation(automationService, draftEditorServiceInstance, docArray);

    session.save();

    docArray = testUtil.getTestWordsArray(session);

    assertTrue("Should have only live documents after publish operation",
