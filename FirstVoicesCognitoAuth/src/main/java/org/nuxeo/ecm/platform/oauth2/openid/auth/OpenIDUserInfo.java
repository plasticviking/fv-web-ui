 ...
 *
 * @see <a href="http://openid.net/specs/openid-connect-basic-1_0.html">Here</a>
 */
public interface OpenIDUserInfo {
  ...
  /**
   * @return End-User's full name in displayable form including all name parts, ordered according to
