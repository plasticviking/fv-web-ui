...
public class FirstVoicesNativeOrderTest {
  ...
  public void testDialectOrderingNisgaa() {
    ...
    String[] orderedAlphabet = {"aa", "a", "b", "d", "e", "ee", "g", "g̱", "gw", "h", "hl", "i",
        "ii", "j", "k",
        "k'", "ḵ", "ḵ'", "kw", "kw'", "l", "Ì", "m", "m̓", "n", "n̓", "o", "oo", "p", "p'", "s",
        "t", "t'",
  ...
  public void testDialectOrderingNuuChahNulth() {
    String[] orderedWords = {"animal", "ʔaʔapp̕iqa", "ʔaḥʔaaʔaaƛ", "ʕaʕac̕ikn̕uk", "aai",
        ...
        "cuwit", "cux" +
        "ʷaašt", "c̓iixaat̓akƛinƛ", "čuup", "č’iʔii", "hachaapsim", "hayu ʔiš muučiiłał",
        "hayuxsyuučiƛ", "k" +
        "̕uʔihta", "ƛułčakup", "ƛ̕uu-čiƛ", "ma", "mułaa", "m̓am̓iiqsu", "naʔaataḥ", "naw̕ahi",
        "nunuukma",
        "piišpiš", "qacc̕a", "qiicqiica", "qiišʔaqƛi", "sasin", "saasin", "suč’a", "šuuwis",
        "t̓iqʷas",
        "uksuukł", "ʔukłaa", "ʕuupqšiƛ", "weʔičʔin", "wiwiiquk", "xʷakak", "yaciicʔił", "yeeł",
        "y̕eʔisi"};

    String[] orderedAlphabet = {"a", "ʔa", "ʕa", "aa", "ʔaa", "ʕaa", "e", "ʔe", "ʕe", "ee", "ʔee",
        "ʕee", "c", "c"
        + "̕", "č", "č’", "h", "ḥ", "i", "ʔi", "ʕi", "ii", "ʔii", "ʕii", "k", "k̕", "kʷ", "k̕ʷ",
        "ł", "ƛ",
        "ƛ̕", "m", "m̕", "n", "n̕", "p", "p̕", "q", "qʷ", "s", "š", "t", "t̕", "u", "ʔu", "ʕu",
        "uu", "ʔuu",
  ...
  public void testDialectOrderingSpacesAndNonAlphabetGraphemesAtEndByLatinOrder() {
    String[] orderedWords = {"À", "Á", "Â", "Ã", "Ä", "Å", "Æ", "Ç", "È", "É", "Ê", "Ë", "Ì", "Í",
        ...
        "ö", "÷",
        "ø", "ù", "ú", "û", "ü", "ý", "þ", "ÿ", "a", "able", "about", "account", "across", "act",
        "addition",
        "adjustment", "advertisement", "after", "again", "against", "agreement", "air", "all",
        "almost",
        "among", "amount", "baby", "back", "bad", "bag", "balance", "ball", "band", "cake",
        "camera", "canvas"
        , "card", "care", "carriage", "damage", "danger", "dark", "daughter", "day", "dead", "dear",
        "death",
        "disgust", "distance", "distribution", "ear", "early", "earth", "east", "edge", "education",
        "effect"
        , "egg", "elastic", "electric", "end", "face", "fact", "fall", "false", "family", "far",
        "farm", "fat"
        , "father", "fear", "feather", "glass", "glove", "go", "goat", "gold", "good", "government",
        "grain",
        "grass", "great", "green", "grey", "grip", "group", "growth", "guide", "gun", "hair",
        "hammer", "hand"
        , "hanging", "happy", "harbor", "ink", "insect", "instrument", "insurance", "interest",
        "invention",
        "iron", "island", "jelly", "jewel", "join", "journey", "judge", "jump", "keep", "kettle",
        "key",
        "kick", "kind", "kiss", "knee", "knife", "knot", "knowledge, land", "language", "last",
        "late", "map"
        , "money", "note", "now", "number", "nut", "observation", "of", "off", "offer", "office",
        "oil", "old"
        , "on", "only", "open", "paste", "payment", "peace", "pen", "pencil", "person", "physical",
        "picture"
        , "quality", "question", "quick", "quiet", "quite, rail", "rain", "range", "rat", "rate",
        "ray",
        "run, sad", "safe", "sail", "salt", "same", "sand", "say", "scale", "school", "science",
        "scissors",
        "strange", "street", "strong", "structure", "substance", "such", "theory", "there", "thick",
        "thin",
        "tight", "till", "time", "tin", "tired", "to", "toe", "together", "unit", "up",
        "use, value", "verse"
        , "very", "vessel", "view", "violent", "voice, waiting", "walk", "wall", "war", "warm",
        "wash", "worm"
  ...
  public void testDialectOrderingPhrases() {
    String[] orderedPhrases = {"À", "Á", "Â", "Ã", "Ä", "Å", "Æ", "Ç", "È", "É", "Ê", "Ë", "Ì", "Í",
        "Î",
        "Ï", "Ð", "Ñ", "Ò", "Ó", "Ô", "Õ", "Ö", "×", "Ø", "Ù", "Ú", "Û", "Ü", "Ý", "Þ", "ß", "à",
        "á", "â",
        "ã", "ä", "å", "æ", "ç", "è", "é", "ê", "ë", "ì", "í", "î", "ï", "ð", "ñ", "ò", "ó", "ô",
        "õ", "ö",
        "÷", "ø", "ù", "ú", "û", "ü", "ý", "þ", "ÿ", "A bad excuse is better than none", "A bit",
        "A bit " +
