  ...
  private ObjectNode constructMediaJSON(DocumentModel doc) throws IOException {
    ...
    if (documentType.equalsIgnoreCase(FV_PICTURE) || documentType.equalsIgnoreCase(FV_AUDIO)
      ...
      String[] sourceIds = (!doc.isProxy())
          ? (String[]) doc.getProperty("fvmedia", "source")
      ...
      String[] recorderIds = (!doc.isProxy())
          ? (String[]) doc.getProperty("fvmedia", "recorder")
      ...
      if (recorderIds != null) {
        ...
        for (String recorderId : recorderIds) {
          ObjectNode recorderObj =
              EnricherUtils.getDocumentIdAndTitleAndPathJsonObject(recorderId, session);
          if (recorderObj != null) {
      ...
      String originId = (!doc.isProxy())
          ? (String) doc.getProperty("fvmedia", "origin")
      ...
      if (originId != null) {
        ...
        ObjectNode originObj =
            EnricherUtils.getDocumentIdAndTitleAndPathJsonObject(originId, session);
        if (originObj != null) {
