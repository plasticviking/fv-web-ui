<@extends src="base_fv.ftl">
    ...
    <@block name="header_scripts">
        <script src="${skinPath}/js/psswd_utils.js"></script>
    </@block>
    <@block name="content">


        <div class="registrationForm">
            <form action="${This.path}/submitNewPassword" method="post" enctype="application/x-www-form-urlencoded"
                  name="submitNewPassword" onsubmit="return validateMyForm();">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="password" id="Password" value="${data['Password']}" name="Password"
                                   class="login_input" isRequired="true" />
                        </td>
                    </tr>
                    <tr>
                        <td class="login_label">
                        ...
                        <td>
                            <input type="password" id="PasswordConfirmation" value="${data['PasswordConfirmation']}"
                                   name="PasswordConfirmation" class="login_input" isRequired="true" />
                        </td>
                    </tr>
                    <tr>
